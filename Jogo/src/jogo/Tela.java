...
public class Tela extends JPanel {
    ...
    protected void paintComponent(Graphics g) {
        ...
        for (int[] item : itens){
            drawSprite(g, item[2], item[3], 16*item[0] - jx + 240, 16*item[1] - jy + 240);
        }
        
        drawSprite(g, spr, clr, 240, 240);
        
        g.drawString("Itens: " + itens.size(), 10, 460);
        g.drawString("X: " + jx + "   Y: " + jy, 10, 480);
